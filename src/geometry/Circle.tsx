...
export function Circle() {
  return (
    <main className="flex-1 p-4 sm:p-6 lg:p-8 overflow-y-auto">
      ...
      <Theorem
        title="Определение: Основни елементи на кръга"
      ...
      <Theorem
        title="Определение: Хорда на кръг"
      ...
      <Theorem
        title="Определение: Дъга и централен ъгъл"
      ...
      <Theorem
        title="Определение: Сектор на кръг"
